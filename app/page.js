...
export default function Home() {
  return (
    <div className="w-[1769px] h-[1211px] relative bg-gradient-to-b from-[#db4439] to-[#75241e] overflow-hidden shadow-lg">
      ...
      <div className="left-[370px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">Menu</div>
      <div className="left-[64px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">Home</div>
      <div className="left-[776px] top-[46px] absolute justify-start text-[#eaecd7] text-2xl font-bold font-['Inknut_Antiqua']">Login</div>
      <div className="w-full h-[102px] left-0 top-[1049px] absolute bg-white flex justify-around items-center"></div>

      <div className="w-full h-[60px] left-0 top-[1049px] absolute bg-white flex justify-around items-center">
